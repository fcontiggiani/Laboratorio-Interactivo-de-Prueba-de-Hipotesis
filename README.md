...
Abrí [`index.html`](https://fcontiggiani.github.io/Laboratorio-Interactivo-de-Prueba-de-Hipotesis/index.html) directamente en el navegador — no requiere servidor.
